...
export function genEvStationMapMarker(evStation: EvStation, pane: string): Marker {
...
function evAddressTemplate(evStation: EvStation) {
...
function evConnectorTypesTemplate(evStation: EvStation) {
