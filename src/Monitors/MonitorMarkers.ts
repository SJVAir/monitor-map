...
interface MonitorMarkersService {
  monitorMarkers: L.FeatureGroup;
  monitorMarkersVisibility: CheckboxDisplayOptions;
}

export const useMonitorMarkers = asyncInitializer<MonitorMarkersService>((resolve, reject) => {
